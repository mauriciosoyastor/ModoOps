/**
 * PROTOTYPE — throwaway onboarding UI wired to mo_onboarding_tour.
...
function renderShell(step) {
    if (session.track === "app") {
        main.innerHTML = `
          <div class="tiles" data-hint=".mo-launcher-shell--root">
            <div class="tile" data-hint=".mo-launcher-shell--hub">Ventas</div>
