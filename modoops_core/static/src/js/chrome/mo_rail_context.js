...
export const LAUNCHER_ACTION_TAG = "modoops_app_launcher";
...
export const RAIL_SHELL_CHANGE_EVENT = "mo_RAIL:SHELL_CHANGE";
...
/**
 * Which chrome zone wraps `.mo-rail__toggle` in the OWL template markup.
