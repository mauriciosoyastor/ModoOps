...
import { applyPinCycle, computeRailExpanded } from "../chrome/mo_rail_context";

const PIN_STORAGE_KEY = "mo_rail_pin";
...
export const sgRailService = {
    ...
    start(env, { action }) {
        ...
        const isShellView = () =>
            Boolean(
                document.querySelector(".mo-launcher-shell--root, .mo-launcher-shell--hub")
            );
...
registry.category("services").add("mo_rail", sgRailService);
