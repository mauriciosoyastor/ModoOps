...
export class PurchaseHub extends Component {
    static template = "modoops_core.PurchaseHub";
    ...
    async loadHubData() {
        ...
        const payload = await this.hubService.loadHub("purchase", this.state.section);
