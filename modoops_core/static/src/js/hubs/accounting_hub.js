...
import { SgSectionRail } from "../components/mo_section_rail";
import { SgEntryCard } from "../components/mo_entry_card";

export class AccountingHub extends Component {
    static template = "modoops_core.AccountingHub";
    ...
    async loadHubData() {
        ...
        const payload = await this.hubService.loadHub("accounting", this.state.section);
