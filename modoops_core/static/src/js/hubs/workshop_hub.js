...
export class WorkshopHub extends Component {
    static template = "modoops_core.WorkshopHub";
    ...
    async loadHubData() {
        ...
        const payload = await this.hubService.loadHub("workshop", this.state.section);
