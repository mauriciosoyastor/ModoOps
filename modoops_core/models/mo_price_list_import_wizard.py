...
from . import mo_price_list_import_logic as logic


class SgPriceListImportWizard(models.TransientModel):
    _name = "mo.price.list.import.wizard"
    ...
    def action_download_template(self):
        ...
        attachment = self.env["ir.attachment"].create(
            {
                "name": "plantilla_lista_precios_modoops.csv",
                "type": "binary",
    ...
    def action_build_preview(self):
        ...
        Line = self.env["mo.price.list.import.line"]
    ...
    def action_apply(self):
        ...
        self.env["mo.price.list.import.log"].create(
            {
