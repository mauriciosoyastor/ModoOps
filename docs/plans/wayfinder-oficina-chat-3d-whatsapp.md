...
- [Contrato payload WhatsApp→Configurador](.scratch/oficina-chat-3d-whatsapp/issues/T3-payload-whatsapp.md): `wa.me/5493547532008` (URL 687 chars), gate `validarBorrador`, traducción a `generar` con hard gate fiscal esperado; ejemplo verificado por keys (sin Python funcional en esta sesión).
